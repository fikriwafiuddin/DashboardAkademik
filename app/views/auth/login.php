...
<body>
    <div class="h-screen w-screen px-3 flex justify-center items-center">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 w-full max-w-96">
            ...
            <form action="<?= BASEURL ?>/auth/post_login" method="post">
                ...
                <button type="submit" class="w-full py-1 bg-blue-600 hover:bg-blue-700 text-white rounded mt-4">Submit</button>
            </form>
        </div>
    </div>
</body>
